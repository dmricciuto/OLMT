...
for i in range(1,int(options.ninst)+1):
    ...
    if (('ED' in compset or 'FATES' in compset) and options.fates_fixed_biogeog):
      output.write(" use_fates_fixed_biogeog = .true.\n")
    if (('ED' in compset or 'FATES' in compset) and options.fates_nocomp):
      output.write(" use_fates_nocomp = .true.\n")
