...
parser.add_option("--pft", dest="mypft", default=-1, \
                  help = 'Use this PFT (override site default, only works when pointdata generated by OLMT, & FATES requires fixed_biogeog)')
...
parser.add_option("--fates_fixed_biogeog", dest="fates_fixed_biogeog", default=False, action="store_true", \
                  help = 'Set fates fixed biogeography to true')
parser.add_option("--fates_nocomp", dest="fates_nocomp", default=False, action="store_true", \
                  help = 'Set fates no competition to true')
...
parser.add_option("--var_list_pft", dest="var_list_pft", default="",
...
#---------------- build base command for all calls to runcase.py -----------------------------
        ...
        if (options.fates_fixed_biogeog):
            basecmd = basecmd+ ' --fates_fixed_biogeog '
        if (options.fates_nocomp):
            basecmd = basecmd+ ' --fates_nocomp '
