...
# PFLOTRAN-ELM coupled source directory, by default taking it from ~/.bashrc (if defined), OR as following
CLM_PFLOTRAN_SOURCE_DIR=/lustre/or-scratch/cades-ccsi/proj-shared/models/pflotran-elm-interface/src/pflotran-elm-interface
...
python ./site_fullrun.py \
      ...
      --model_root /lustre/or-scratch/cades-ccsi/proj-shared/models/E3SM-Coastal \
      --caseroot /lustre/or-scratch/cades-ccsi/proj-shared/project_acme/cases \
      --ccsm_input /nfs/data/ccsi/proj-shared/E3SM/inputdata \
      --runroot /lustre/or-scratch/cades-ccsi/scratch/$USER \
      --spinup_vars \
      --humhol \
      ...
      --np 1 \
      --nopointdata \
      --domainfile /lustre/or-scratch/cades-ccsi/proj-shared/project_acme/cesminput_ngee/share/domains/domain.clm/domain.lnd.2x1pt_US-GC3_navy_vji.nc \
      --surffile /lustre/or-scratch/cades-ccsi/proj-shared/project_acme/cesminput_ngee/lnd/clm2/surfdata_map/surfdata_2x1pt_US-GC3_simyr1850.nc \
      --landusefile /lustre/or-scratch/cades-ccsi/proj-shared/project_acme/cesminput_ngee/lnd/clm2/surfdata_map/surfdata.pftdyn_2x1pt_US-GC3_simyr1850-2015.nc
